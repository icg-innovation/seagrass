...
class TestPrepare(unittest.TestCase):
    def test_return_features(self):
        ...
        features = prepare.return_features(data)
    ...
    def test_return_features_bands(self):
        ...
        features = prepare.return_features(data, bands)
    ...
    def test_return_features_blurring(self, mock_gaussian_filter):
        ...
        bands = [0]
        features = prepare.return_features(data, bands, blurring=True)
    ...
    def test_create_training_data(self):
        ...
        X, y = prepare.create_training_data(data, ground_truth, no_data_value)
